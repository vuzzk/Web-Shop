...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="margin-bottom: 100px; margin-top: 10px">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="txtSurname" runat="server" CssClass="form-control shadow" ReadOnly="false"></asp:TextBox>
        </div>

        <div class="form-group">
            <h5 style="margin-top:10px;">Korisničko ime</h5>
            <asp:TextBox ID="txtUsername" runat="server" CssClass="form-control shadow" ReadOnly="false"></asp:TextBox>
        </div>
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="txtPassword" runat="server" CssClass="form-control shadow" ReadOnly="false"></asp:TextBox>
        </div>

        <div class="form-group">
            <h5 style="margin-top:10px;">Država</h5>
            <asp:TextBox ID="txtCountry" runat="server" CssClass="form-control shadow" ReadOnly="false"></asp:TextBox>
        </div>

        <div class="form-group">
            <h5 style="margin-top:10px;">Grad</h5>
            <asp:TextBox ID="txtCity" runat="server" CssClass="form-control shadow" ReadOnly="false"></asp:TextBox>
        </div>

        <div class="form-group">
            <h5 style="margin-top:10px;">Poštanski broj</h5>
            <asp:TextBox ID="txtPostCode" runat="server" CssClass="form-control shadow" ReadOnly="false"></asp:TextBox>
        </div>

        <div class="form-group">
            <h5 style="margin-top:10px;">Adresa</h5>
            <asp:TextBox ID="txtAddress" runat="server" CssClass="form-control shadow" ReadOnly="false"></asp:TextBox>
        </div>
        ...
        <asp:Button ID="btnSaveChanges" runat="server" style="margin-top:30px;" Text="Save Changes" CssClass="btn btn-outline-success text-center" OnClick="btnSaveChanges_Click"/>
    </div>
